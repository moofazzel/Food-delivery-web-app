        ...
        <div>
            <div className='flex justify-center items-center flex-col'>
                <div className='flex overflow-x-hidden relative'>
                    <div className='flex transition-transform duration-300 ease-in-out' style={{ transform: `translateX(-${startIndex * (100 / 5)}%)` }}>
                        {ourClientsData.map((data) => (
                            <div key={data.id} className='mr-4' style={{ flex: `0 0 ${100 / 5}%` }}>
