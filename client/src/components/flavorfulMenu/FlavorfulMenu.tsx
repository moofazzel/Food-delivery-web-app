        ...
        <section className="py-14 lg:py-20">
            <div className="container mx-auto px-2 md:px-4 lg:px-10">
                <div className="text-center mb-16">
                    <h2 className="text-black font-semibold text-3xl lg:text-[32px] mb-5">Our Flavorful Menus</h2>
                    <p className="text-base text-black px-2 lg:px-[267px]">Odio Morbi Quis Commodo Odio Aenean Sed Adipiscing. Neque Ornare Aenean Euismod Elementum Nisi Quis.</p>
                            ...
                            <div className="w-full lg:w-6/12" key={menu.id}>
                                <div className="mx-4 mb-10 lg:mb-14 fmenu_card">
                                    <div className="block  lg:flex items-center justify-center">
                                        <img src={menu.img} alt="" className='mx-auto lg:mx-0 mb-6 lg:mb-0' />
                                        <div className="ml-5 ">
                                            <div className="flex items-center ">
                                                <h3 className="text-[1rem] lg:text-xl lg:font-medium font-semibold text-primary mb-4">{menu.productName}</h3>
                                                <div className='cus_b'></div>
                                                <span className="text-xl font-medium text-black mb-4">{menu.price}</span>
                                            </div>
